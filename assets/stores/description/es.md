...
Si necesita ingresar texto y traducirlo, simplemente haga clic en el botón Leukothea para abrir la ventana emergente.

Traducción de página completa
Con Leukothea, puede convenientemente traducir páginas web completas con solo un clic. Todo lo que necesita hacer es seleccionar "Traducir página" del menú contextual en cualquier página web, y será instantáneamente traducido a su idioma preferido.

¡Haga su propia base de conocimientos personal con Leukothea!
...
Leukothea puede traducir textos incluso sin internet, una característica que ninguna otra extensión tiene. El traductor sin conexión le permite traducir textos en su dispositivo sin enviar ningún mensaje privado por Internet, garantizando su privacidad. Simplemente habilite la función en la página de opciones para mantener su privacidad mientras traduce correos electrónicos de trabajo y mensajes personales.

Personalice Leukothea como desee
A diferencia de otras extensiones de navegador, Leukothea no es simplemente un envoltorio sobre el Widget de Traductor de Google; es un sistema de traducción completo e independiente. Por eso, Leukothea no está limitado en cuanto a qué características se pueden implementar. Leukothea es la principal extensión para la traducción de páginas web. Únase a Leukothea y comience a usar las funciones más avanzadas ahora y siempre manténgase a la vanguardia del progreso tecnológico en el futuro.

Usted tiene control total sobre sus datos y cómo funciona Leukothea para usted:
...
Privacidad
Leukothea es gratuito, de código abierto y nunca recopila tus datos personales.
